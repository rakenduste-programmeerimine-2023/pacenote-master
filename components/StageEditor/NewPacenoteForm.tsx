        ...
        <form onSubmit={handleSubmit} className="icon-form">
            ...
            <div className="icon-section">
              ...
              <div className="icon-row">
                ...
                <label><input type="radio" name="action" value="RSquare" checked={formData.action === 'RSquare'} onChange={(e) => setFormData({ ...formData, action: e.target.value, icon: 'RSquare' })}/> <img src="/PacenoteIcons/RSquare.png" alt="RSquare" className="icon-image" /></label>
                ...
                <label><input type="radio" name="action" value="RSlight" checked={formData.action === 'RSlight'} onChange={(e) => setFormData({ ...formData, action: e.target.value, icon: 'RSlight' })}/> <img src="/PacenoteIcons/RSlight.png" alt="RSlight" className="icon-image" /></label>
              </div>
            </div>
            {/* Events */}
            <div className="icon-section">
              <h3>Events</h3>
              <div className="icon-row">
                <label><input type="radio" name="action" value="Straight" checked={formData.action === 'Straight'} onChange={(e) => setFormData({ ...formData, action: e.target.value, icon: 'Straight' })}/> <img src="/PacenoteIcons/Straight.png" alt="Straight" className="icon-image" /></label>
                <label><input type="radio" name="action" value="LChicane" checked={formData.action === 'LChicane'} onChange={(e) => setFormData({ ...formData, action: e.target.value, icon: 'LChicane' })}/> <img src="/PacenoteIcons/LChicane.png" alt="LChicane" className="icon-image" /></label>
                <label><input type="radio" name="action" value="RChicane" checked={formData.action === 'RChicane'} onChange={(e) => setFormData({ ...formData, action: e.target.value, icon: 'RChicane' })}/> <img src="/PacenoteIcons/RChicane.png" alt="RChicane" className="icon-image" /></label>
                <label><input type="radio" name="action" value="Dip" checked={formData.action === 'Dip'} onChange={(e) => setFormData({ ...formData, action: e.target.value, icon: 'Dip' })}/> <img src="/PacenoteIcons/Dip.png" alt="Dip" className="icon-image" /></label>
                <label><input type="radio" name="action" value="Bump" checked={formData.action === 'Bump'} onChange={(e) => setFormData({ ...formData, action: e.target.value, icon: 'Bump' })}/> <img src="/PacenoteIcons/Bump.png" alt="Bump" className="icon-image" /></label>
                <label><input type="radio" name="action" value="Crest" checked={formData.action === 'Crest'} onChange={(e) => setFormData({ ...formData, action: e.target.value, icon: 'Crest' })}/> <img src="/PacenoteIcons/Crest.png" alt="Crest" className="icon-image" /></label>
                <label><input type="radio" name="action" value="Jump" checked={formData.action === 'Jump'} onChange={(e) => setFormData({ ...formData, action: e.target.value, icon: 'Jump' })}/> <img src="/PacenoteIcons/Jump.png" alt="Jump" className="icon-image" /></label>
                <label><input type="radio" name="action" value="Twisting" checked={formData.action === 'Twisting'} onChange={(e) => setFormData({ ...formData, action: e.target.value, icon: 'Twisting' })}/> <img src="/PacenoteIcons/Twisting.png" alt="Twisting" className="icon-image" /></label>
                <label><input type="radio" name="action" value="Watersplash" checked={formData.action === 'Watersplash'} onChange={(e) => setFormData({ ...formData, action: e.target.value, icon: 'Watersplash' })}/> <img src="/PacenoteIcons/Watersplash.png" alt="Watersplash" className="icon-image" /></label>
              </div>
            </div>
            {/* notes */}
